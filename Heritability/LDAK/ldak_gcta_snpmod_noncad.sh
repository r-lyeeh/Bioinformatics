...
# run  exclusion of snp_gwascad
### input & run ~~~~~~~~~~~~~~~~~~

mkdir ${working_directory}/${id_snplist}/res_${name_snplist}_nonsnpcad304ld02
cd ${working_directory}/${id_snplist}/res_${name_snplist}_nonsnpcad304ld02

cat ${snplist} /raid2/zeng/work_zeng_summary/work_zeng_archived/20180904-20190228_h2modules224/h2_SimonKoplev_20180904/snplist_Nelson304/snp_Nelson304_500kbld02 /raid2/zeng/work_zeng_summary/work_zeng_archived/20180904-20190228_h2modules224/h2_SimonKoplev_20180904/snplist_Nelson304/snp_Nelson304_500kbld02 | sort | uniq -u > snp_${name_snplist}_nonsnpcad304ld02
this_snplist=./snp_${name_snplist}_nonsnpcad304ld02
# fulllist: this_snplist=${snplist}
...
#	(which LDAK now does by default when cutting predictors into sections)
	ldak5.linux --cut-weights sections_chr${chr} --bfile ${this_plinkfile}
	...
	do
	ldak5.linux --calc-weights sections_chr${chr}  --bfile ${this_plinkfile} --subset-number 2 --subset-prefix ../plinkfile/sub --section ${i}
	echo calc-weights section_1st ${i} finished.
	done
	ldak5.linux --join-weights sections_chr${chr} --bfile ${this_plinkfile}

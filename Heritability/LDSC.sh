#!/bin/bash
cd /home/pang/Desktop/GRN_Johan_20191215/224_mesc/snplist_ld/full
source activate ldsc
#idlist=$1
GERGWAS=/home/pang/Desktop/GRN_Johan_20191215/224_mesc/UKB/ukb.assoc
for i in snpmod0_Final snpmod0.ld02 snpmod0.ld05
do
awk 'FNR==NR{a[$1]=$1;next}($2 in a){print $2,$4,$7}' ${i} ${GERGWAS} >module_${i}
...
#ldsc.py --h2 module_${i}_sub.sumstats.gz --ref-ld-chr ${ref_ld}/EUR_chr@_phase_v3_ld --w-ld-chr ${w_ld}/EUR_chr@_phase_v3_w_ld --out module_${i}_h2
